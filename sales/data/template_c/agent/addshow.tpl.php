<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2017-02-09 18:33:53, compiled from ./web/template/agent/addshow.htm */ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
  ...
  <div class="body-content">
	<form id="form" class="form-x" >
     ...
     <div class="form-group">
        ...
        <div class="field">
		    <input name="yaoqingma" id="yaoqingma" type="hidden" value="<?php echo $jingjireninfo['phone'];?>" />
...
function sub(obj){
	...
	{
		$.ajax({
			url: '/agent/<?php echo $action;?>_save',
			type: 'post',
			dataType:'json',
			data: $('#form').serialize(),
