<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2017-02-28 11:36:09, compiled from ./web/template/company/editinfo.htm */ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
  ...
  <div class="body-content">
	<form id="form" class="form-x" >
      <div class="form-group">
        ...
        <div class="field">
		  <input name="companyname" type="text" class="input w50" id="companyname" value="<?php echo $data['companyname'];?>" />       
          <div class="tips"></div>
        </div>
      </div> 
       ...
       <div class="form-group">
        ...
        <div class="field">
          <div class="button-group radio">
			<input name="status" type="radio" value="1" <?php if ($data['status']==1) { ?> checked="checked" <?php } ?> />正常&nbsp;&nbsp;
			<input name="status" type="radio" value="0" <?php if ($data['status']==0) { ?> checked="checked" <?php } ?> />禁用
