<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2017-02-28 12:58:46, compiled from ./web/template/company/run.htm */ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
  ...
  <table class="table table-hover text-center">
    ...
    <tr>
      ...
      <a type="button" class="button border-main" href="/company/edit/id/<?php echo $vo['id'];?>"><span class="icon-edit"></span>修改</a>
